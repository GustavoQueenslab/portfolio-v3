  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        />
        <path
          d="M124,144.610951 L124,163 L128,163 L128,163 C167.764502,163 
        200,195.235498 200,235 L200,244 L0,244 L0,235 C-4.86974701e-15,195.235498
         32.235498,163 72,163 L72,163 L76,163 L76,144.610951 C58.7626345,136.422372 46.3722246,119.687011 44.3051388,99.8812385 C38.4803105,99.0577866 34,94.0521096 34,88 L34,74 C34,68.0540074 38.3245733,63.1180731 44,62.1659169 L44,56 L44,56 C44,25.072054 69.072054,5.68137151e-15 100,0 L100,0 L100,0 C130.927946,-5.68137151e-15 156,25.072054 156,56 L156,62.1659169 C161.675427,63.1180731 166,68.0540074 166,74 L166,88 C166,94.0521096 161.51969,99.0577866 155.694861,99.8812385 C153.627775,119.687011 141.237365,136.422372 124,144.610951 Z"
          id="path-5"
        />
      </defs>
      <g
            ...
            >
              ...
              >
                ...
                <mask id="react-mask-178" fill="white">
                  <use xlinkHref="#react-path-177" />
                </mask>
                <use
                  id="Hoodie"
                  fill="#B7C1DB"
                  fillRule="evenodd"
                  xlinkHref="#react-path-177"
                />
                <g
                  id="Color/Palette/Gray-01"
                  mask="url(#react-mask-178)"
                  fillRule="evenodd"
                  fill="#25557C"
                >
              ...
              <g id="Top" strokeWidth={1} fillRule="evenodd">
                ...
                <mask id="react-mask-129" fill="white">
                  <use xlinkHref="#react-path-131" />
                </mask>
                <g id="Mask" />
                <g id="Top/Short-Hair/Short-Curly" mask="url(#react-mask-129)">
                  <g transform="translate(-1.000000, 0.000000)">
                    <mask id="react-mask-128" fill="white">
                      <use xlinkHref="#react-path-130" />
                    </mask>
                    <use
                      id="Short-Hair"
                      stroke="none"
                      fill="#28354B"
                      fillRule="evenodd"
                      xlinkHref="#react-path-130"
                    />
                    <g
                      id="Skin/👶🏽-03-Brown"
                      mask="url(#react-mask-128)"
                      fill="#D6B370"
                    >
                    ...
                    >
                      ...
                      <g id="Lennon-Glasses">
                        <use
                          fill="black"
                          fillOpacity={1}
                          filter="url(#react-filter-144)"
                          xlinkHref="#react-path-143"
                        />
                        <use
                          fill="#252C2F"
                          fillRule="evenodd"
